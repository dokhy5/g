...
class GTextThemes {
  GTextThemes._(); // Constructor private to prevent instantiation
  static TextTheme lightTextTheme= TextTheme(
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 12,fontWeight: FontWeight.w400,color: Colors.black.withOpacity(0.5)),
  ...
  static TextTheme darkTextTheme= TextTheme(
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 12,fontWeight: FontWeight.w400,color: Colors.white.withOpacity(0.5)),
